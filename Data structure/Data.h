...
void open_Door(Automat*);                       // opens automate door

void close_Door(Automat*);                      // closes automate door
...
void buy_Product(Automat*);                     // buy currently selected product (if possible)
...
void update_Temperature_and_Humidity(Automat*); // update temperature and humidity
